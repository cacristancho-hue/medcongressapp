    ...
    <div ref={containerRef} className="relative w-full max-w-xl mb-8">
      <div className="relative group">
        ...
        <input
          ...
          placeholder="Búsqueda Médica Global (ej. fármaco, dosis, autor)..."
          ...
          <div className="overflow-y-auto flex-1 custom-scrollbar">
            {results.length === 0 && !isSearching ? (
              <div className="p-8 text-center">
                <p className="text-sm text-slate-500">No se encontraron resultados para esta búsqueda clínica.</p>
              </div>
            ) : (
              results.map((res) => (
                <Link 
