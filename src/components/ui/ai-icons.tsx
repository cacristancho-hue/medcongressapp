...
export function GeminiIcon() {
  return (
    <svg viewBox="0 0 24 24" className="h-6 w-6" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M12 2C12 2 12.5 8.5 19 11.5C12.5 14.5 12 21 12 21C12 21 11.5 14.5 5 11.5C11.5 8.5 12 2 12 2Z" fill="url(#gemini-grad-real)" />
      <defs>
        <linearGradient id="gemini-grad-real" x1="5" y1="2" x2="19" y2="21">
...
export function CrossRefIcon() {
  return (
    <div className="flex items-center gap-1 opacity-40 hover:opacity-100 transition-opacity grayscale hover:grayscale-0">
      <div className="w-2 h-2 rounded-full bg-[#EF3E36]"></div>
      <span className="text-[10px] font-bold text-slate-400">CrossRef</span>
    </div>
  )
}
...
export function PubMedIcon() {
  return (
    <div className="flex items-center gap-1 opacity-40 hover:opacity-100 transition-opacity grayscale hover:grayscale-0">
      ...
      <span className="text-[10px] font-bold text-slate-400">PubMed</span>
    </div>
  )
}
...
export function OpenAlexIcon() {
  return (
    <div className="flex items-center gap-1 opacity-40 hover:opacity-100 transition-opacity grayscale hover:grayscale-0">
      ...
      <span className="text-[10px] font-bold text-slate-400">OpenAlex</span>
    </div>
  )
}
